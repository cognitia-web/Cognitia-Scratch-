...
export default function AuroraBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden will-change-auto">
      ...
      {/* Aurora effect - optimized with will-change */}
      ...
      {/* Animated gradients - reduced animation complexity */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(110,205,254,0.1),transparent_50%)] will-change-opacity" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(161,136,255,0.1),transparent_50%)] will-change-opacity" />
    </div>
  )
}
